...
public class FilaBasicaWorker : BackgroundService
{
    private readonly ILogger<FilaBasicaWorker> _logger;
    private readonly ServiceBusClient _serviceBusClient;
    private readonly string _queueName = "fila-basica";

    public FilaBasicaWorker(ILogger<FilaBasicaWorker> logger, ServiceBusClient serviceBusClient)
    {
        _logger = logger;
